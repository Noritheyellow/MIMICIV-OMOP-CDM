...
DROP TABLE IF EXISTS mimic_omop_cdm.src_diagnoses_icd;
CREATE TABLE mimic_omop_cdm.src_diagnoses_icd AS
SELECT
    subject_id                      AS subject_id,
    hadm_id                         AS hadm_id,
    seq_num                         AS seq_num,
...
DROP TABLE IF EXISTS mimic_omop_cdm.src_services;
CREATE TABLE mimic_omop_cdm.src_services AS
SELECT
    subject_id                          AS subject_id,
    hadm_id                             AS hadm_id,
    transfertime                        AS transfertime,
...
DROP TABLE IF EXISTS mimic_omop_cdm.src_labevents;
CREATE TABLE mimic_omop_cdm.src_labevents AS
SELECT
    labevent_id                         AS labevent_id,
    subject_id                          AS subject_id,
    charttime                           AS charttime,
...
DROP TABLE IF EXISTS mimic_omop_cdm.src_d_labitems;
CREATE TABLE mimic_omop_cdm.src_d_labitems AS
SELECT
    itemid                              AS itemid,
    label                               AS label,
    fluid                               AS fluid,
...
DROP TABLE IF EXISTS mimic_omop_cdm.src_procedures_icd;
CREATE TABLE mimic_omop_cdm.src_procedures_icd AS
SELECT
    subject_id                          AS subject_id,
    hadm_id                             AS hadm_id,
    icd_code                            AS icd_code,
...
DROP TABLE IF EXISTS mimic_omop_cdm.src_hcpcsevents;
CREATE TABLE mimic_omop_cdm.src_hcpcsevents AS
SELECT
    hadm_id                             AS hadm_id,
    subject_id                          AS subject_id,
    hcpcs_cd                            AS hcpcs_cd,
...
DROP TABLE IF EXISTS mimic_omop_cdm.src_drgcodes;
CREATE TABLE mimic_omop_cdm.src_drgcodes AS
SELECT
    hadm_id                             AS hadm_id,
    subject_id                          AS subject_id,
    drg_code                            AS drg_code,
...
DROP TABLE IF EXISTS mimic_omop_cdm.src_prescriptions;
CREATE TABLE mimic_omop_cdm.src_prescriptions AS
SELECT
    hadm_id                             AS hadm_id,
    subject_id                          AS subject_id,
    pharmacy_id                         AS pharmacy_id,
...
DROP TABLE IF EXISTS mimic_omop_cdm.src_microbiologyevents;
CREATE TABLE mimic_omop_cdm.src_microbiologyevents AS
SELECT
    microevent_id                   AS microevent_id,
    subject_id                      AS subject_id,
    hadm_id                         AS hadm_id,
...
-- -------------------------------------------------------------------
-- DROP TABLE IF EXISTS mimic_omop_cdm.src_diagnoses_icd;
-- CREATE TABLE mimic_omop_cdm.src_d_micro AS
-- SELECT
--     itemid                      AS itemid, -- numeric ID
--     label                       AS label, -- source_code for custom mapping
--     category                    AS category, 
...
-- MIMIC IV 2.0: generate src_d_micro from microbiologyevents
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS mimic_omop_cdm.src_d_micro;
CREATE TABLE mimic_omop_cdm.src_d_micro AS
WITH d_micro AS (
...
DROP TABLE IF EXISTS mimic_omop_cdm.src_pharmacy;
CREATE TABLE mimic_omop_cdm.src_pharmacy AS
SELECT
    pharmacy_id                         AS pharmacy_id,
    medication                          AS medication,
    -- hadm_id                             AS hadm_id,
